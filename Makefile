...
# Build flags
LDFLAGS := -X github.com/andpalmier/mbzr/cmd.Version=$(VERSION) \
           -X github.com/andpalmier/mbzr/cmd.Commit=$(COMMIT) \
           -X github.com/andpalmier/mbzr/cmd.BuildDate=$(BUILD_DATE)
